  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/90 text-gray-900 p-10 rounded-xl shadow-xl max-w-2xl w-full text-center border-4 border-gray-300">
        <h1 className="text-4xl font-bold">Female 7-Day Workout Plan</h1>
        ...
        <ul className="list-disc text-left mt-6 space-y-3 px-6 text-lg">
          ...
          <li>
            <strong>Day 2:</strong> Upper Body (Back, Biceps, Shoulders)
          </li>
          <li>
            <strong>Day 3:</strong> Core & Cardio
          </li>
          <li>
            <strong>Day 4:</strong> Lower Body (Quads, Glutes, Calves)
          </li>
          <li>
            <strong>Day 5:</strong> Upper Body (Chest, Arms, Shoulders)
          </li>
          <li>
