...
export default function WorkoutSpiltNav({onBack}) {

  const [showModal, setShowModal] = useState(false); 

  return (
    <div className="bg-cover bg-center bg-no-repeat min-h-screen flex items-center justify-center" style={{ backgroundImage: `url(${Bg})` }}>
