...
export default function Female5Days() {
  const workoutPlan = [
    ...
    },
    {
      ...
      name: "Full Body + Core",
      exercises: [
        { name: "Jumping Ropes", gif: "jumping-ropes.gif" },
        {
        ...
        { name: "Plank Hold (3×30 seconds)", gif: "plank-hold.gif" },
      ],
    },
    {
      day: "Day 7",
      ...
      <div className="relative flex flex-col items-center flex-grow px-10 py-16 w-full">
        <div className="bg-black/80 text-white p-12 rounded-2xl shadow-xl w-full max-w-6xl">
          <h1 className="text-4xl font-bold text-center">
            Minimalist 5-Day Workout Plan (Female)
          </h1>
          <p className="mt-6 text-lg text-center">
            A structured Push, Pull, Legs routine with additional full-body
            workout and optimal rest days.
          </p>
          <motion.div
